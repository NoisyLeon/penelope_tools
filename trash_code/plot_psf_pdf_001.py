...
# x, y, z     = np.mgrid[-1e-5:1e-5:51j, -1e-5:1e-5:51j, 0:1e-5:51j]
# x, y, z     = np.mgrid[-1e-5:1e-5:51j, -1e-5:1e-5:51j, 0:1e-5:11j]
x, y, z     = np.mgrid[-1e-5:1e-5:201j, -1e-5:1e-5:201j, 0:0:1j]
...
# plotx, ploty = np.mgrid[-1e-5:1e-5:51j, -1e-5:1e-5:51j]
plotx, ploty = np.mgrid[-1e-5:1e-5:201j, -1e-5:1e-5:201j]
ax.pcolor(plotx, ploty, zpdf, offset=0, zdir='z')
# # 
# # #This is new

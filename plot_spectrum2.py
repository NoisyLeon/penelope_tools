...
plt.ylabel('Photons/sec', fontsize=25)
plt.title('Input Spectrum: Stage 0', fontsize=30)
...
plt.bar(dbase.ebins, dbase.Np_out, color='red', edgecolor='red')
plt.ylabel('Photons/sec', fontsize=25)
plt.title('Spectrum after '+r'$Al (2 \mu{m})$'+': Stage 1', fontsize=30)
# plt.xlabel('Energy (eV)', fontsize=30)
ax.tick_params(axis='x', labelsize=0)
ax.tick_params(axis='y', labelsize=20)
plt.yscale('log', nonposy='clip')
...
plt.bar(dbase.ebins, dbase.Np_out, color='red', edgecolor='red')
plt.ylabel('Photons/sec', fontsize=25)
plt.title('Spectrum after '+r'$IC (5 \mu{m})$'+': Stage 2', fontsize=30)
# plt.xlabel('Energy (eV)', fontsize=30)
ax.tick_params(axis='x', labelsize=0)
ax.tick_params(axis='y', labelsize=20)
plt.yscale('log', nonposy='clip')
...
# plt.bar(dbase.ebins, dbase.Np_out, color='red', edgecolor='red')
# plt.ylabel('Photons/sec', fontsize=25)
# plt.title('Spectrum after '+r'$W (2 \mu{m})$'+': Stage 2', fontsize=30)
# # plt.xlabel('Energy (eV)', fontsize=30)
# ax.tick_params(axis='x', labelsize=0)
# ax.tick_params(axis='y', labelsize=20)
# plt.yscale('log', nonposy='clip')
...
plt.ylabel('Photons/sec', fontsize=25)
plt.title('Spectrum absorbed by the detector after '+r'$Bi (4.1 \mu{m})$'+': Stage 4', fontsize=30)

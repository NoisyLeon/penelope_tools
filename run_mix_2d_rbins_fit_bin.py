...
N2      = dbase.energy.size

dbase.count_r_bins( rmax=800., Nr=401)
dbase.count_r_bins_mix_2d_3(Nt=19000./N1*N2,sigma=5., p1=0.983020554066, p2=0.00893655049151, C1=17., C2=68., rmax=800., Nr=401, plotfig=False)
